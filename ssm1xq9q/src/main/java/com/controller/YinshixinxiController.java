...
public class YinshixinxiController {
    ...
    public R save(@RequestBody YinshixinxiEntity yinshixinxi, HttpServletRequest request){
    	yinshixinxi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YinshixinxiEntity> wrapper = new EntityWrapper<YinshixinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yinshixinxiService.selectCount(wrapper);
