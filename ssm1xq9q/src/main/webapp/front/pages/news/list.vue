<template>
    ...
    <view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
		...
		<view :style="2 != 1 ? 'display: flex;' : ''">
            ...
            <!-- 样式2 -->
            <!-- 样式3 -->
            <view class="news-box3" :style='{"padding":"20rpx 10rpx","boxShadow":"0px 6rpx 12rpx rgba(0, 0, 0, 0.16)","margin":"0 0 20rpx","borderColor":"red","backgroundColor":"rgba(255,255,255,1)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
        <view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"padding":"20rpx","boxShadow":"0px 6rpx 12rpx rgba(0, 0, 0, 0.16)","margin":"20rpx 0","borderColor":"#ccc","backgroundColor":"rgba(255,255,255,1)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' style="display: flex;align-items: center;">
          <view :style='{"padding":"0","boxShadow":"0px 0 0px rgba(153,153,153,1)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(70, 176, 60, 1)","borderRadius":"50%","borderWidth":"0","width":"16rpx","borderStyle":"solid","height":"16rpx"}' class="dian"></view>
          <view :style='{"padding":"0 20rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"calc(100% - 40rpx)","lineHeight":"72rpx","fontSize":"28rpx","borderStyle":"solid"}' class="title hide1">{{product.title}}</view>
          <view class="cuIcon-right" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","borderWidth":"0","width":"32rpx","lineHeight":"72rpx","fontSize":"32rpx","borderStyle":"solid"}'></view>
        </view>
      </view>
            <!-- 样式4 -->
            <!-- 样式5 -->
