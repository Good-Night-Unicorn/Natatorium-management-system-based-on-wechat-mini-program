<template>
	<view class="content">
		<view @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}" :style='{"padding":"0 24rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0, 186, 189, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"260rpx"}'>
			...
			<view :style='{"padding":"0 24rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0, 0, 0, 0)","borderRadius":"16rpx","borderWidth":"0","width":"calc(100% - 112rpx)","borderStyle":"solid","height":"160rpx"}'v-if="tableName=='huiyuan'" class="userinfo">
				<view class="face" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 20rpx 0 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"100%","borderWidth":"0","width":"120rpx","borderStyle":"solid","height":"120rpx"}'>
					<image :src="user.touxiang?baseUrl+user.touxiang:'/static/center/face.jpeg'"></image>
				</view>
				<view class="info">
					<view class="username" :style='{"padding":"0","boxShadow":"0 0 16rpx rgba(255,255,255,0)","margin":"6rpx 0","backgroundColor":"rgba(0,0,0,0)","borderColor":"rgba(255,255,255,.3)","color":"#fff","textAlign":"left","borderRadius":"8rpx","borderWidth":"0","width":"auto","lineHeight":"36rpx","fontSize":"24rpx","borderStyle":"solid"}'>{{user.huiyuanzhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
				</view>
			</view>
			<view class="setting">
...
<style lang="scss">
	...
	.content:after {
		...
		bottom: 0;
		content: '';
		background-image: url(http://codegen.caihongy.cn/20220212/610efe89987a43b997db9cc2a8ed4a67.png);
