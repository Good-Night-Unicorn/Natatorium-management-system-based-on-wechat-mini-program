<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="购买编号" prop="goumaibianhao">
            <el-input v-model="ruleForm.goumaibianhao" 
                placeholder="购买编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.goumaibianhao" label="购买编号" prop="goumaibianhao">
              <el-input v-model="ruleForm.goumaibianhao" 
                placeholder="购买编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="饮食编号" prop="yinshibianhao">
          <el-input v-model="ruleForm.yinshibianhao" 
              placeholder="饮食编号" clearable  :readonly="ro.yinshibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="饮食编号" prop="yinshibianhao">
              <el-input v-model="ruleForm.yinshibianhao" 
                placeholder="饮食编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="饮食名称" prop="yinshimingcheng">
          <el-input v-model="ruleForm.yinshimingcheng" 
              placeholder="饮食名称" clearable  :readonly="ro.yinshimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="饮食名称" prop="yinshimingcheng">
              <el-input v-model="ruleForm.yinshimingcheng" 
                placeholder="饮食名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="饮食类型" prop="yinshileixing">
          <el-input v-model="ruleForm.yinshileixing" 
              placeholder="饮食类型" clearable  :readonly="ro.yinshileixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="饮食类型" prop="yinshileixing">
              <el-input v-model="ruleForm.yinshileixing" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.yinshitupian" label="饮食图片" prop="yinshitupian">
          <file-upload
          tip="点击上传饮食图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.yinshitupian" label="饮食图片" prop="yinshitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yinshitupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../ssm1xq9q/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `goumaixinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.goumaixinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
