<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="泳池编号" prop="yongchibianhao">
          <el-input v-model="ruleForm.yongchibianhao" 
              placeholder="泳池编号" clearable  :readonly="ro.yongchibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="泳池编号" prop="yongchibianhao">
              <el-input v-model="ruleForm.yongchibianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="泳池类型" prop="yongchileixing">
          <el-input v-model="ruleForm.yongchileixing" 
              placeholder="泳池类型" clearable  :readonly="ro.yongchileixing"></el-input>
        </el-form-item>
        <div v-else>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yongchiyuding/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yongchiyudingCrossAddOrUpdateFlag = false;
						 this.parent.search();
