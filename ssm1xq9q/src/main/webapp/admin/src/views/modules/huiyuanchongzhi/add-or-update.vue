<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="会员等级" prop="huiyuandengji">
          <el-select :disabled="ro.huiyuandengji" @change="huiyuandengjiChange" v-model="ruleForm.huiyuandengji" placeholder="请选择会员等级">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.huiyuandengji" label="会员等级" prop="huiyuandengji">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `huiyuanchongzhi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.huiyuanchongzhiCrossAddOrUpdateFlag = false;
						 this.parent.search();
