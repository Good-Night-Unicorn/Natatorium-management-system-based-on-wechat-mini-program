<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="场馆编号" prop="changguanbianhao">
            <el-input v-model="ruleForm.changguanbianhao" 
                placeholder="场馆编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.changguanbianhao" label="场馆编号" prop="changguanbianhao">
              <el-input v-model="ruleForm.changguanbianhao" 
                placeholder="场馆编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="场馆名称" prop="changguanmingcheng">
          <el-input v-model="ruleForm.changguanmingcheng" 
              placeholder="场馆名称" clearable  :readonly="ro.changguanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="场馆类型" prop="changguanleixing">
          <el-select :disabled="ro.changguanleixing" v-model="ruleForm.changguanleixing" placeholder="请选择场馆类型">
            <el-option
                v-for="(item,index) in changguanleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.changguantupian" label="场馆图片" prop="changguantupian">
          <file-upload
          tip="点击上传场馆图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.changguantupian?ruleForm.changguantupian:''"
          @change="changguantupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.changguantupian" label="场馆图片" prop="changguantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.changguantupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="开放时间" prop="kaifangshijian">
          <el-input v-model="ruleForm.kaifangshijian" 
              placeholder="开放时间" clearable  :readonly="ro.kaifangshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="开放时间" prop="kaifangshijian">
              <el-input v-model="ruleForm.kaifangshijian" 
                placeholder="开放时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="交通路线" prop="jiaotongluxian">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiaotongluxian" label="交通路线" prop="jiaotongluxian">
                    <span v-html="ruleForm.jiaotongluxian"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="场馆介绍" prop="changguanjieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.changguanjieshao" label="场馆介绍" prop="changguanjieshao">
                    <span v-html="ruleForm.changguanjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  data() {
	...
	changguanjieshao : false,
      ...
      rules: {
          ...
          changguanweizhi: [
                { required: true, message: '场馆位置不能为空', trigger: 'blur' },
          ],
          lianxiren: [
          ],
          lianxidianhua: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='changguanbianhao'){
            this.ruleForm.changguanbianhao = obj[o];
	    this.ro.changguanbianhao = true;
            continue;
          }
	    ...
	    this.ro.changguanleixing = true;
          ...
          if(o=='changguantupian'){
            this.ruleForm.changguantupian = obj[o];
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.changguanleixingOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.jiaotongluxian = this.ruleForm.jiaotongluxian.replace(reg,'../../../ssm1xq9q/upload');
	this.ruleForm.changguanjieshao = this.ruleForm.changguanjieshao.replace(reg,'../../../ssm1xq9q/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.changguantupian!=null) {
		this.ruleForm.changguantupian = this.ruleForm.changguantupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    changguantupianUploadChange(fileUrls) {
	this.ruleForm.changguantupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
