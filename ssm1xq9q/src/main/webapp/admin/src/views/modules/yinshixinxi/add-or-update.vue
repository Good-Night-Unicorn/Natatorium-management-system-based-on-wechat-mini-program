  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yinshibianhao" label="饮食编号" prop="yinshibianhao">
              <el-input v-model="ruleForm.yinshibianhao" 
                placeholder="饮食编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="饮食类型" prop="yinshileixing">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="饮食详情" prop="yinshixiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yinshixiangqing" label="饮食详情" prop="yinshixiangqing">
                    <span v-html="ruleForm.yinshixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.yinshixiangqing = this.ruleForm.yinshixiangqing.replace(reg,'../../../ssm1xq9q/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
